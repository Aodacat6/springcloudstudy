...
public class DirectMQConfig {
     ...
     */
    @Bean("deadExchange")
    public DirectExchange deaExchange() {
        //DirectExchange(String name, boolean durable, boolean autoDelete, Map<String, Object> arguments)
        return new DirectExchange("Dead-Exchange",true,false,null);
    }
    ...
    @Bean
    public Binding bindDead(@Qualifier("deadExchange") DirectExchange exchange,
